...
public class modBlocks {
    ...
    public static final RegistryObject<Block> ROOTED_DIRT_STAIRS = registerBlock ("rooted_dirt_stairs",
            ()->new StairBlock (Blocks.ROOTED_DIRT::defaultBlockState, BlockBehaviour.Properties.copy (Blocks.GRASS_BLOCK).sound (SoundType.GRASS)));
    public static final RegistryObject<Block> PACKED_MUD_STAIRS = registerBlock ("packed_mud_stairs",
            ()->new StairBlock (Blocks.PACKED_MUD::defaultBlockState, BlockBehaviour.Properties.copy (Blocks.GRASS_BLOCK).sound (SoundType.GRASS)));
    ...
    public static final RegistryObject<Block> MOSS_STAIRS = registerBlock ("moss_stairs",
            ()->new StairBlock (Blocks.MOSS_BLOCK::defaultBlockState, BlockBehaviour.Properties.copy (Blocks.GRASS_BLOCK).sound (SoundType.GRASS)));
    public static final RegistryObject<Block> SAND_STAIRS = registerBlock ("sand_stairs",
            ()->new StairBlock (Blocks.SAND::defaultBlockState, BlockBehaviour.Properties.copy (Blocks.GRASS_BLOCK).sound (SoundType.GRASS)));
    ...
    public static final RegistryObject<Block> MUD_STAIRS = registerBlock ("mud_stairs",
            ()->new StairBlock (Blocks.MUD::defaultBlockState, BlockBehaviour.Properties.copy (Blocks.GRASS_BLOCK).sound (SoundType.GRASS)));
    public static final RegistryObject<Block> RED_SAND_STAIRS = registerBlock ("red_sand_stairs",
            ()->new StairBlock (Blocks.RED_SAND::defaultBlockState, BlockBehaviour.Properties.copy (Blocks.GRASS_BLOCK).sound (SoundType.GRASS)));
    public static final RegistryObject<Block> NETHER_WART_STAIRS = registerBlock ("nether_wart_stairs",
            ()->new StairBlock (Blocks.NETHER_WART_BLOCK::defaultBlockState, BlockBehaviour.Properties.copy (Blocks.GRASS_BLOCK).sound (SoundType.GRASS)));
    public static final RegistryObject<Block> WARPED_WART_STAIRS = registerBlock ("warped_wart_stairs",
            ()->new StairBlock (Blocks.WARPED_WART_BLOCK::defaultBlockState, BlockBehaviour.Properties.copy (Blocks.GRASS_BLOCK).sound (SoundType.GRASS)));
    ...
    public static final RegistryObject<Block> SOUL_SAND_STAIRS = registerBlock ("soul_sand_stairs",
            ()->new StairBlock (Blocks.SOUL_SAND::defaultBlockState, BlockBehaviour.Properties.copy (Blocks.GRASS_BLOCK).sound (SoundType.GRASS)));
    public static final RegistryObject<Block> SOUL_SOIL_STAIRS = registerBlock ("soul_soil_stairs",
            ()->new StairBlock (Blocks.SOUL_SOIL::defaultBlockState, BlockBehaviour.Properties.copy (Blocks.GRASS_BLOCK).sound (SoundType.GRASS)));
